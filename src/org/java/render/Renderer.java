...
public class Renderer {
    ...
    public void render(
        ...
        shader.setUniform("uTilePeriod", settings.tilePeriod);
       ...
       // shader.setUniform("uUseBlueNoise", settings.useBlueNoise);
        ...
        shader.setUniform("uPowderStrength", settings.powderStrength);
        shader.setUniform("uBlendFactor", settings.blendFactor);
        ...
        shader.setUniform("uStepSize",settings.stepSize);
        shader.setUniform("uShadowStepSize",settings.shadowStepSize);
        ...
        shader.setUniform("uVolumetricScattering", settings.volumetricScattering);
        shader.setUniform("uPhaseG", settings.phaseG);

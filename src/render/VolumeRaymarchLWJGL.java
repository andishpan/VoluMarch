...
//gui
        ...
        // inputHandler = new util.InputHandler(window);

        //  textRenderer = new render.TextRenderer(width, height);
...
// light,debug,water
   ...
   /* private void handleKeyboardInput() {
        ...
        if (inputHandler.isKeyPressed(GLFW_KEY_W)) {
            cameraPosition = cameraPosition.add(new util.Vector3f(0, 0, -camSpeed));
        }
        if (inputHandler.isKeyPressed(GLFW_KEY_S)) {
            cameraPosition = cameraPosition.add(new util.Vector3f(0, 0, camSpeed));
        }
        if (inputHandler.isKeyPressed(GLFW_KEY_A)) {
            cameraPosition = cameraPosition.add(new util.Vector3f(-camSpeed, 0, 0));
        }
